...
void test_append(void) {
    ...
    Order o;
    OrderList_init(&ol);
    Order_create(&o, "A:AUDUSD:200:1.32");
    ...
    TEST_ASSERT_EQUAL_STRING("AUDUSD", ol.orders[0].instrument);
...
void test_append_two(void) {
    ...
    Order o;
    OrderList_init(&ol);
    OrderList_append(&ol, Order_create(&o, "A:AUDUSD:200:1.32"));
    OrderList_append(&ol, Order_create(&o, "B:AUDUSD:-100:1.32"));
...
void test_sort_inorder(void) {
    ...
    OrderList_init(&ol);
    OrderList_append(&ol, Order_create(&o, "A:AUDUSD:200:1.32"));
    OrderList_append(&ol, Order_create(&o, "B:AUDUSD:100:1.31"));
...
void test_sort_stable(void) {
    ...
    OrderList_init(&ol);
    OrderList_append(&ol, Order_create(&o, "A:AUDUSD:200:1.31"));
    OrderList_append(&ol, Order_create(&o, "B:AUDUSD:100:1.31"));
