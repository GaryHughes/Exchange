...
private:
	...
	using buy_order_collection = std::priority_queue<order, std::vector<order>, buy_ordering>;
	using sell_order_collection = std::priority_queue<order, std::vector<order>, sell_ordering>;
